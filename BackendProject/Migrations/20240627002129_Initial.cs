    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LecturerComponents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LecturerComponents_Lecturers_LecturerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Categories_Multilinguals_NameId",
                        column: x => x.NameId,
                        principalTable: "Multilinguals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Components_Multilinguals_NameId",
                        column: x => x.NameId,
                        principalTable: "Multilinguals",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FAQItems_Multilinguals_AnswerId",
                        column: x => x.AnswerId,
                        principalTable: "Multilinguals",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FAQItems_Multilinguals_QuestionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MultilingualItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MultilingualItems_Multilinguals_MultiLingualId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subjects_Multilinguals_NameId",
                        column: x => x.NameId,
                        principalTable: "Multilinguals",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FAQItems_AnswerId",
                table: "FAQItems",
                column: "AnswerId");

            migrationBuilder.CreateIndex(
                name: "IX_FAQItems_QuestionId",
                table: "FAQItems",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_LecturerComponents_LecturerId",
                table: "LecturerComponents",
                column: "LecturerId");

            migrationBuilder.CreateIndex(
                name: "IX_Lecturers_PersonalId",
                table: "Lecturers",
                column: "PersonalId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MultilingualItems_MultiLingualId",
                table: "MultilingualItems",
                column: "MultiLingualId");

            migrationBuilder.CreateIndex(
                name: "IX_OTPCodes_Source",
                table: "OTPCodes",
                column: "Source");
